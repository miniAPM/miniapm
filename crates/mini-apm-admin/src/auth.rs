...
<<<<<<<< HEAD:crates/mini-apm-admin/src/api/auth.rs
use mini-apm::DbPool;
========
use mini-apm::{DbPool, models};
>>>>>>>> 90258bc (feat: migrate miniapm-admin from axum to rama and separate collector):crates/mini-apm-admin/src/auth.rs
...
<<<<<<<< HEAD:crates/mini-apm-admin/src/api/auth.rs
    match mini-apm::models::project::find_by_api_key(&pool, api_key) {
========
...
mod tests {
    ...
    async fn test_auth_rejects_invalid_key() {
        ...
        mini-apm::models::project::ensure_default_project(&pool).unwrap();
    ...
    async fn test_auth_accepts_valid_project_key() {
        let pool = create_test_pool();
        let project = mini-apm::models::project::ensure_default_project(&pool).unwrap();
